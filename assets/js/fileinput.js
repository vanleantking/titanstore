...
(function (factory) {
    ...
    tFileIcon = '<i class="fa fa-file-image-o"></i>';
    ...
    defaultPreviewSettings = {
        image: {width: "auto", height: "300px", 'max-width': "500px",'max-height': "350px"},
    ...
    FileInput.prototype = {
        ...
        _showUploadError: function (msg, params, event) {
            var uploadmsgerror = "Không thể upload file :";
            var self = this, $error = self.$errorContainer, ev = event || 'fileuploaderror', e = params && params.id ?
            '<li data-file-id="' + params.id + '">' + uploadmsgerror + msg + '</li>' : '<li>' + msg + '</li>';
